...
class _DateRangePickerState extends State<DateRangePicker> {
  var selectedDateRange; // Corrected type reference here
  ...
  void showCustomDateRangePicker() async {
    ...
    if (picked != null) {
      setState(() {
        ...
        FFAppState().startRangeDate = picked.start;
        FFAppState().endRangeDate = picked.end;
        widget.updatePageUI();
      });
    }
  }
      ...
      child: ElevatedButton(
        ...
        child: Padding(
          ...
          child: selectedDateRange != null
              ? Text(
                  '${DateFormat('d/M/y').format(selectedDateRange!.start)} to ${DateFormat('d/M/y').format(selectedDateRange!.end)}',
                  style: TextStyle(
